...
public interface DessertsApi {
  ...
  @ApiOperation(value = "returns desserts", nickname = "getDesserts", notes = "Get list of all desserts ", response = Dessert.class, responseContainer = "List", tags = {
      "developers",})
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "returns dessert information about the given dessert.", nickname = "getDessertsByName", notes = "Get information of the given dessert ", response = Dessert.class, responseContainer = "List", tags = {
      "developers",})
  @ApiResponses(value = {
