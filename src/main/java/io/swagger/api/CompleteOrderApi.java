...
public interface CompleteOrderApi {
  ...
  @ApiOperation(value = "Completes the given order", nickname = "completeOrder", notes = "Finalizes the order with payement information and marking order complete. Once completed the order can not be modified. ", response = Receipt.class, tags = {
      "developers",})
  @ApiResponses(value = {
