...
public interface StoresApi {
    ...
    @ApiOperation(value = "returns all stores", nickname = "getStores", notes = "Get list of all stores ", response = Store.class, responseContainer = "List", tags={ "developers", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "get store by id", nickname = "getStoresById", notes = "Get store details by id ", response = Store.class, tags={ "developers", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/stores/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Store> getStoresById(@ApiParam(value = "StoreId",required=true) @PathVariable("id") String id);
