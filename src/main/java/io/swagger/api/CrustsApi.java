...
public interface CrustsApi {
  ...
  @ApiOperation(value = "returns information about the given crust.", nickname = "getCrustByName", notes = "Get information of the given crust ", response = Crust.class, responseContainer = "List", tags = {
      "developers",})
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "returns all crust options", nickname = "getCrusts", notes = "Get list of all crusts ", response = Crust.class, responseContainer = "List", tags = {
      "developers",})
  @ApiResponses(value = {
