...
public interface OrderApi {
  ...
  @ApiOperation(value = "creates a new order", nickname = "createOrder", notes = "Creates a new order with provided ItemList(optional). Returns order object. ", response = Order.class, tags = {
      "developers",})
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "returns all orders", nickname = "getOrders", notes = "Get list of all orders ", response = Order.class, responseContainer = "List", tags = {
      "developers",})
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "get order by id", nickname = "getOrdersById", notes = "Get order details by id ", response = Order.class, tags = {
      "developers",})
  @ApiResponses(value = {
  ...
  @ApiOperation(value = "updates the given order", nickname = "updateOrder", notes = "update the given order with given parameters. ", response = Order.class, tags = {
      "developers",})
  @ApiResponses(value = {
