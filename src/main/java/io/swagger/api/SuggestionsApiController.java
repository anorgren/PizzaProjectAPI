...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen",
        date = "2019-10-22T18:16:30.929Z[GMT]")
@Controller
public class SuggestionsApiController implements SuggestionsApi {
    ...
    public ResponseEntity<PizzaSuggestion> getNumberOfPizzas(
            ...
            @ApiParam(value = "The preferred size, if given all suggested pizzas will be this size. " +
                    "Must be a valid size (small, medium, large).")
