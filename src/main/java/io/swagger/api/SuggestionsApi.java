...
public interface SuggestionsApi {
    ...
    @ApiOperation(value = "Returns a suggested number of pizzas to order given the number of adults and children " +
            "that will be enjoying it.", nickname = "getNumberOfPizzas",
            notes = "Suggests how many pizzas to order based on the number of people in the ordering group.",
            response = PizzaSuggestion.class, tags = {"suggestions",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "The number of small, medium, and large pizzas to order.",
                    response = PizzaSuggestion.class),
    ...
    ResponseEntity<PizzaSuggestion> getNumberOfPizzas(
            ...
            @ApiParam(value = "The preferred size, if given all suggested pizzas will be this size. Must be a " +
